...
class EventType(StrEnum):
    ...
    TASK_REFERENCE_RESOLVED = "task_reference_resolved"
    TASK_RECURRENCE_BACKLOG_SKIPPED = "task_recurrence_backlog_skipped"
    TASK_BATCH_COMPLETED = "task_batch_completed"
